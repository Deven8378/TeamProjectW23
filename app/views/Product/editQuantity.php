...
<div class='common-container' align='center'>
	...
	?>	
		...
		<div class="grid-50" align="center">
			...
			<input class="input-qty" type="date" required autocomplete="off" name="produced_date" value="<?= $data->produced_date ?>"<?php if ($isEmployee) {echo "style='border:3px solid red;' readonly";}?>>
